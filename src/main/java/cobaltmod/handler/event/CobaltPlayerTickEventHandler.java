...
public class CobaltPlayerTickEventHandler {
	...
	private static final AttributeModifier cobaltspeedBootsMoveBonus = (new AttributeModifier(cobaltspeedBootsMoveBonusUUID, "Cobalt Speed Boots Speed Bonus", CMMain.forwardspeedboots, 2)).setSaved(false);
