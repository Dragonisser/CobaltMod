...
public class CraftingHandler {
	...
	public void onCrafting(ItemCraftedEvent event) {
		...
		} else if (event.crafting.getItem() == CMContent.cobalthoe || event.crafting.getItem() == CMContent.cobaltshovel
				|| event.crafting.getItem() == CMContent.cobaltaxe || event.crafting.getItem() == CMContent.cobaltpickaxe) {
		...
		} else if (event.crafting.getItem() == CMContent.cobaltboots || event.crafting.getItem() == CMContent.cobaltlegs
				|| event.crafting.getItem() == CMContent.cobalthelmet || event.crafting.getItem() == CMContent.cobaltplate) {
