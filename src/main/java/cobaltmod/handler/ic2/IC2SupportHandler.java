...
public class IC2SupportHandler 
{
	public static void isIC2Installed()
	{
		...
		if(Loader.isModLoaded("IC2"))
		{
			...
			{								
				//Definition
				CMContent.crushed_cobaltore = new ItemCrushedCobalt().setUnlocalizedName(CMMain.MODID +":crushed_cobaltore").setTextureName(CMMain.MODID + ":crushed_cobaltore").setCreativeTab(CMMain.cobalttabitems);
				CMContent.purified_crushed_cobaltore = new ItemPurifiedCrushedCobalt().setUnlocalizedName(CMMain.MODID +":purified_crushed_cobaltore").setTextureName(CMMain.MODID + ":purified_crushed_cobaltore").setCreativeTab(CMMain.cobalttabitems);
				CMContent.cobaltdust = new ItemCobaltDust().setUnlocalizedName(CMMain.MODID + ":cobaltdust").setTextureName(CMMain.MODID + ":cobaltdust").setCreativeTab(CMMain.cobalttabitems);		
				CMContent.cobaltdusttiny = new ItemCobaltDustTiny().setUnlocalizedName(CMMain.MODID + ":cobaltdusttiny").setTextureName(CMMain.MODID + ":cobaltdusttiny").setCreativeTab(CMMain.cobalttabitems);		 
				
				CMContent.carthundust = new ItemCarthunDust().setUnlocalizedName(CMMain.MODID + ":carthundust").setTextureName(CMMain.MODID + ":carthundust").setCreativeTab(CMMain.cobalttabitems);		
				CMContent.carthundusttiny = new ItemCarthunDustTiny().setUnlocalizedName(CMMain.MODID + ":carthundusttiny").setTextureName(CMMain.MODID + ":carthundusttiny").setCreativeTab(CMMain.cobalttabitems);		
				CMContent.crushed_carthunore = new ItemCrushedCarthun().setUnlocalizedName(CMMain.MODID +":crushed_carthunore").setTextureName(CMMain.MODID + ":crushed_carthunore").setCreativeTab(CMMain.cobalttabitems);
				CMContent.purified_crushed_carthunore = new ItemPurifiedCrushedCarthun().setUnlocalizedName(CMMain.MODID +":purified_crushed_carthunore").setTextureName(CMMain.MODID + ":purified_crushed_carthunore").setCreativeTab(CMMain.cobalttabitems);
				...
				//Recipe
			    GameRegistry.addRecipe(new ItemStack(CMContent.cobaltdust, 1), new Object [] {"###", "###", "###", Character.valueOf('#'), CMContent.cobaltdusttiny});
			    GameRegistry.addRecipe(new ItemStack(CMContent.carthundust, 1), new Object [] {"###", "###", "###", Character.valueOf('#'), CMContent.carthundusttiny});
				...
				Recipes.centrifuge.addRecipe(new RecipeInputItemStack(new ItemStack(CMContent.crushed_cobaltore)), metadata, new ItemStack(CMContent.cobaltdust), new ItemStack(CMContent.cobaltdusttiny, 1));
			
				NBTTagCompound metadata1 = new NBTTagCompound();
				metadata1.setInteger("amount", 1000);
				Recipes.oreWashing.addRecipe(new RecipeInputItemStack(new ItemStack(CMContent.crushed_cobaltore)), metadata, new ItemStack(CMContent.purified_crushed_cobaltore), new ItemStack(CMContent.cobaltdusttiny, 2));
				...
				Recipes.centrifuge.addRecipe(new RecipeInputItemStack(new ItemStack(CMContent.crushed_carthunore)), metadata, new ItemStack(CMContent.carthundust), new ItemStack(CMContent.carthundusttiny, 1));
			
				NBTTagCompound metadata4 = new NBTTagCompound();
				metadata4.setInteger("amount", 1000);
				Recipes.oreWashing.addRecipe(new RecipeInputItemStack(new ItemStack(CMContent.crushed_carthunore)), metadata, new ItemStack(CMContent.purified_crushed_carthunore), new ItemStack(CMContent.carthundusttiny, 2));
