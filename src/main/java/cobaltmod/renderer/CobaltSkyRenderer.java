...
public class CobaltSkyRenderer extends IRenderHandler {
	private int starGLCallList;
	private int glSkyList;
	private int glSkyList2;

	ResourceLocation sun = new ResourceLocation("");
	ResourceLocation moon = new ResourceLocation("");

	public CobaltSkyRenderer() {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		mc.renderEngine.getTexture(sun); // Sun
											// texture
											// +
											// texture
											// path
		...
		f10 = 7.5F; // Size of moon from center
		mc.renderEngine.getTexture(moon); // Moon
											// texture
											// +
											// texture
											// path
