...
public class TileEntityCobexChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public TileEntityCobexChestRenderer()
    {
     ...
     */
    public void render(TileEntityCobexChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockCobexChest && i == 0)
            {
                try
                {
                    ((BlockCobexChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.render((TileEntityCobexChest)par1TileEntity, par2, par4, par6, par8);
    }
}
