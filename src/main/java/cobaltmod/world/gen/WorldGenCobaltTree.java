...
import cobaltmod.main.blocks.BlockCobexSapling;

public class WorldGenCobaltTree extends WorldGenAbstractTree
{
    /**
    ...
    public WorldGenCobaltTree(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenCobaltTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockCobexSapling)CMContent.cobexsapling);
                        ...
                        for (i2 = par3 - l1; i2 <= par3 + l1; ++i2)
                        {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, CMContent.cobexleaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
