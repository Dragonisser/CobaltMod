						...
						label101: {
							...
							if (p_76484_1_.isAirBlock(i2, p_76484_4_, j2)) {
								...
								if (k2 == 1) {
									...
									TileEntityCobexChest tileentitychest = (TileEntityCobexChest) p_76484_1_.getTileEntity(i2, p_76484_4_, j2);

									if (tileentitychest != null) {
										WeightedRandomChestContent.generateChestContents(p_76484_2_,
												ChestGenHooksCobalt.getItems(ChestGenHooksCobalt.COBALT_DUNGEON_CHEST, p_76484_2_), tileentitychest,
