...
public class WorldGenMineableCobalt extends WorldGenerator
{
    ...
    public WorldGenMineableCobalt(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, CMContent.corruptedstone);
    }

    public WorldGenMineableCobalt(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenMineableCobalt(Block block, int meta, int number, Block target)
    {
