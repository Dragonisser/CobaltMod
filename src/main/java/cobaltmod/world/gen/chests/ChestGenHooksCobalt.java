...
public class ChestGenHooksCobalt {
	...
	private static final HashMap<String, ChestGenHooksCobalt> chestInfo = new HashMap<String, ChestGenHooksCobalt>();
	...
	private static void addInfo(String category, WeightedRandomChestContent[] items, int min, int max) {
		chestInfo.put(category, new ChestGenHooksCobalt(category, items, min, max));
	}
	 ...
	 */
	public static ChestGenHooksCobalt getInfo(String category) {
		if (!chestInfo.containsKey(category)) {
			chestInfo.put(category, new ChestGenHooksCobalt(category));
		}
	...
	public ChestGenHooksCobalt(String category) {
		this.category = category;
	}

	public ChestGenHooksCobalt(String category, WeightedRandomChestContent[] items, int min, int max) {
		this(category);
	...
	public WeightedRandomChestContent getChestGenBase(ChestGenHooksCobalt chestGenHooksCobalt, Random rnd, WeightedRandomChestContent original) {
		return original;
	}
	...
	public ItemStack getOneItem(Random rand) {
		...
		ItemStack[] stacks = ChestGenHooksCobalt.generateStacks(rand, item.theItemId, item.theMinimumChanceToGenerateItem, item.theMaximumChanceToGenerateItem);
