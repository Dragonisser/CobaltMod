...
public class ChunkProviderCobaltCaves implements IChunkProvider {
	...
	{
		// genNetherBridge = (MapGenNetherBridge)
		// TerrainGen.getModdedMapGen(genNetherBridge, NETHER_BRIDGE);
		netherCaveGenerator = TerrainGen.getModdedMapGen(netherCaveGenerator, NETHER_CAVE);
	}

	public ChunkProviderCobaltCaves(World p_i2005_1_, long p_i2005_2_) {
		this.worldObj = p_i2005_1_;
		this.hellRNG = new Random(p_i2005_2_);
		this.netherNoiseGen1 = new NoiseGeneratorOctaves(this.hellRNG, 16);
		this.netherNoiseGen2 = new NoiseGeneratorOctaves(this.hellRNG, 16);
		this.netherNoiseGen3 = new NoiseGeneratorOctaves(this.hellRNG, 8);
		// this.slowsandGravelNoiseGen = new NoiseGeneratorOctaves(this.hellRNG,
		// 4);
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								...
								if (k1 * 8 + l1 < b1) {
									block = CMContent.darkwater;
								}

								if (d15 > 0.0D) {
									block = CMContent.hardendcorruptedstone;
								}
	...
	public void replaceBiomeBlocks(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_, byte[] meta, BiomeGenBase[] biomes) {
		ChunkProviderEvent.ReplaceBiomeBlocks event = new ChunkProviderEvent.ReplaceBiomeBlocks(this, p_147418_1_, p_147418_2_, p_147418_3_, meta, biomes,
				this.worldObj);
		...
		double d0 = 0.03125D;
		// this.slowsandNoise =
		// this.slowsandGravelNoiseGen.generateNoiseOctaves(this.slowsandNoise,
		// p_147418_1_ * 16, p_147418_2_ * 16, 0, 16, 16, 1, d0, d0,
		// 1.0D);
		// this.gravelNoise =
		// this.slowsandGravelNoiseGen.generateNoiseOctaves(this.gravelNoise,
		// p_147418_1_ * 16, 109, p_147418_2_ * 16, 16, 1, 16, d0, 1.0D, d0);
		this.netherrackExclusivityNoise = this.netherrackExculsivityNoiseGen.generateNoiseOctaves(this.netherrackExclusivityNoise, p_147418_1_ * 16,
				p_147418_2_ * 16, 0, 16, 16, 1, d0 * 2.0D, d0 * 2.0D, d0 * 2.0D);
		...
		for (int k = 0; k < 16; ++k) {
			for (int l = 0; l < 16; ++l) {
				...
				int j1 = -1;
				Block block = CMContent.corruptedstone;
				Block block1 = CMContent.hardendcorruptedstone;
				...
				for (int k1 = 127; k1 >= 0; --k1) {
					...
					if (k1 < 127 - this.hellRNG.nextInt(5) && k1 > 0 + this.hellRNG.nextInt(5)) {
						...
						if (block2 != null && block2.getMaterial() != Material.air) {
							if (block2 == CMContent.hardendcorruptedstone) {
								if (j1 == -1) {
									if (i1 <= 0) {
										block = null;
	...
	public Chunk provideChunk(int p_73154_1_, int p_73154_2_) {
		...
		BiomeGenBase[] abiomegenbase = this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[]) null, p_73154_1_ * 16, p_73154_2_ * 16, 16,
				16); // Forge Move up to allow for passing to replaceBiomeBlocks
	...
	private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_3_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
		...
		double d0 = 684.412D;
		double d1 = 2053.236D;
		this.noiseData4 = this.netherNoiseGen6.generateNoiseOctaves(this.noiseData4, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, 1, p_73164_7_, 1.0D, 0.0D,
				1.0D);
		this.noiseData5 = this.netherNoiseGen7.generateNoiseOctaves(this.noiseData5, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, 1, p_73164_7_, 100.0D,
				0.0D, 100.0D);
		this.noiseData1 = this.netherNoiseGen3.generateNoiseOctaves(this.noiseData1, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_,
				d0 / 80.0D, d1 / 60.0D, d0 / 80.0D);
		this.noiseData2 = this.netherNoiseGen1.generateNoiseOctaves(this.noiseData2, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_,
				d0, d1, d0);
		this.noiseData3 = this.netherNoiseGen2.generateNoiseOctaves(this.noiseData3, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_,
				d0, d1, d0);
		int k1 = 0;
		int l1 = 0;
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
		...
		// //(new WorldGenHellLava(Blocks.flowing_lava,
		// false)).generate(this.worldObj, this.hellRNG, j1, k1, l1);
		// }
		...
		// doGen = TerrainGen.populate(p_73153_1_, worldObj, hellRNG,
		// p_73153_2_, p_73153_3_, false, GLOWSTONE);
		// for (j1 = 0; doGen && j1 < i1; ++j1) {
		// k1 = k + this.hellRNG.nextInt(16) + 8;
		// l1 = this.hellRNG.nextInt(120) + 4;
		// i2 = l + this.hellRNG.nextInt(16) + 8;
		// (new WorldGenGlowStone1()).generate(this.worldObj, this.hellRNG, k1,
		// l1, i2);
		// }
		...
		// i2 = l + this.hellRNG.nextInt(16) + 8;
		// (new WorldGenGlowStone2()).generate(this.worldObj, this.hellRNG, k1,
		// l1, i2);
		// }
		...
		// j2 = l + this.hellRNG.nextInt(16);
		// (new WorldGenHellLava(Blocks.flowing_lava,
		// true)).generate(this.worldObj, this.hellRNG, l1, i2, j2);
		// }
