...
public class WorldChunkManagerCobaltCaves extends WorldChunkManager {
	// public static ArrayList<BiomeGenBase> allowedBiomes = new
	// ArrayList<BiomeGenBase>(Arrays.asList(forest, plains, taiga, taigaHills,
	// forestHills, jungle, jungleHills));
	...
	protected WorldChunkManagerCobaltCaves() {
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.biomesToSpawnIn.add(BiomeGenBaseCobalt.biomecaves);
	}

	public WorldChunkManagerCobaltCaves(long seed, WorldType par3WorldType) {
		this();
		GenLayer[] agenlayer = GenLayerCobaltCaves.makeTheWorld(seed);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerCobaltCaves(World par1World) {
	...
	public BiomeGenBase getBiomeGenAt(int par1, int par2) {
		...
		if (biome == null) {
			return BiomeGenBaseCobalt.biomecaves;
		}
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = BiomeGenBaseCobalt.biomecaves;
			}
		}
