...
public class TeleporterCobalt extends Teleporter
{
    ...
    public TeleporterCobalt(WorldServer par1WorldServer)
    {
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        boolean flag = j1 < 0;
                        /** change this block **/
                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? CMContent.portalframe : Blocks.air);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        /** change this block **/
                        if (this.worldServerInstance.getBlock(k1, i2, l1) == CMContent.cobaltportal)
                        {
                            /** change this block **/
                            while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == CMContent.cobaltportal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new PortalPositionCobalt(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            /** change this block **/
            if (this.worldServerInstance.getBlock(i - 1, j, k) == CMContent.cobaltportal)
            {
                j2 = 2;
            }
            ...
            /** change this block **/
            if (this.worldServerInstance.getBlock(i, j, k - 1) == CMContent.cobaltportal)
            {
                j2 = 3;
            }
            ...
            for (k2 = -1; k2 <= 1; ++k2)
            {
                for (i3 = 1; i3 < 3; ++i3)
                {
                    for (l2 = -1; l2 < 3; ++l2)
                    {
                        ...
                        flag = l2 < 0;
                        /** change this block **/
                        this.worldServerInstance.setBlock(k3, j3, i4, flag ? CMContent.portalframe : Blocks.air);
                    }
                }
            }
        }
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    /** change these blocks **/
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? CMContent.portalframe : CMContent.cobaltportal, 0, 2);
                }
            }
