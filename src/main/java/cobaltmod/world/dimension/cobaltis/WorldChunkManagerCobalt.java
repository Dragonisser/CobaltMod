...
public class WorldChunkManagerCobalt extends WorldChunkManager
{
    ...
    protected WorldChunkManagerCobalt()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
        this.biomesToSpawnIn.add(BiomeGenBaseCobalt.biomehills);
        this.biomesToSpawnIn.add(BiomeGenBaseCobalt.biomeplains);
        this.biomesToSpawnIn.add(BiomeGenBaseCobalt.biomeswamp);
        this.biomesToSpawnIn.add(BiomeGenBaseCobalt.biometall);
    }

    public WorldChunkManagerCobalt(long seed, WorldType par3WorldType)
    {
        this();
    ...
    public WorldChunkManagerCobalt(World par1World)
    {
    ...
    public BiomeGenBase getBiomeGenAt(int par1, int par2)
    {
    	...
    	if (biome == null)
    	{
    		return BiomeGenBaseCobalt.biomeplains;
    	}
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5)
    {
        ...
        for (int i = 0; i < par4 * par5; ++i) {
	        ...
	        {
	        	par1ArrayOfBiomeGenBase[i] = BiomeGenBaseCobalt.biomeplains;
	        }
        }
