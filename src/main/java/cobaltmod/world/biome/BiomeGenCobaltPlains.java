...
public class BiomeGenCobaltPlains extends BiomeGenBaseCobalt {
	@SuppressWarnings("unchecked")
	public BiomeGenCobaltPlains(int par1, boolean register) {
		super(par1, register);
	...
	protected static final BiomeGenBaseCobalt.Height height_Default = new BiomeGenBaseCobalt.Height(0.2F, 0.2F);
