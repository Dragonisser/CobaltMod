...
public class BiomeGenCobaltHills extends BiomeGenBaseCobalt {
	@SuppressWarnings("unchecked")
	public BiomeGenCobaltHills(int par1, boolean register) {
		super(par1, register);
	...
	protected static final BiomeGenBaseCobalt.Height height_Default = new BiomeGenBaseCobalt.Height(0.7F, 0.5F);
