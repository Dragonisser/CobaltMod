...
public class CobaltPacketDispatcher {
	...
	private static final <REQ extends IMessage> void registerMessage(Class<? extends CobaltAbstractMessageHandler<REQ>> handlerClass, Class<REQ> messageClass) {
		...
		} else if (CobaltAbstractServerMessageHandler.class.isAssignableFrom(handlerClass)) {
			registerMessage(handlerClass, messageClass, Side.SERVER);
		} else if (CobaltAbstractBiMessageHandler.class.isAssignableFrom(handlerClass)) {
