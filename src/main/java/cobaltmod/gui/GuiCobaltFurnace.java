...
public class GuiCobaltFurnace extends GuiContainer
{
    ...
    private TileEntityCobaltFurnace furnaceInventory;

    public GuiCobaltFurnace(InventoryPlayer par1InventoryPlayer, TileEntityCobaltFurnace par2TileEntityFurnace)
    {
        super(new ContainerCobaltFurnace(par1InventoryPlayer, par2TileEntityFurnace));
