...
public class ContainerCobaltFurnace extends Container
{
private TileEntityCobaltFurnace highSpeed;
private int lastCookTime = 0;
private int lastBurnTime = 0;
private int lastItemBurnTime = 0;
public ContainerCobaltFurnace(InventoryPlayer par1InventoryPlayer, TileEntityCobaltFurnace par2TileEntityHighSpeedFurnace)
{
...
public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
{
         ...
         if (var4 != null && var4.getHasStack())
         {
                 ...
                 else if (par2 != 1 && par2 != 0)
                 {
                         ...
                         else if (TileEntityCobaltFurnace.isItemFuel(var5))
                         {
