...
public class SlotBlueWoodWorkBenchCrafting extends Slot
{
    /**
    ...
    public SlotBlueWoodWorkBenchCrafting(EntityPlayer par1EntityPlayer, IInventory par2IInventory, IInventory par3IInventory, int par4, int par5, int par6)
    {
