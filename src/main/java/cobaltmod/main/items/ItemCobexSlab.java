...
public class ItemCobexSlab extends ItemBlock
{
    private final boolean field_150948_b;
    private final BlockSlab field_150949_c;
    private final BlockSlab field_150947_d;

    public ItemCobexSlab(Block p_i45355_1_)
    {
        super(p_i45355_1_);
        this.field_150949_c = CMContent.cobexsingleslab;
        this.field_150947_d = CMContent.cobexdoubleslab;
