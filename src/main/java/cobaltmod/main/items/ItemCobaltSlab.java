...
public class ItemCobaltSlab extends ItemBlock
{
    ...
    public ItemCobaltSlab(Block p_i45355_1_)
    {
        super(p_i45355_1_);
        this.field_150949_c = CMContent.cobaltbricksingleslab;
        this.field_150947_d = CMContent.cobaltbrickdoubleslab;
