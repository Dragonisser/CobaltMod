...
{
	private static final HashSet<Block> field_150915_c = Sets.newHashSet(new Block[] {Blocks.cobblestone, Blocks.double_stone_slab, Blocks.stone_slab, Blocks.stone, Blocks.sandstone, Blocks.mossy_cobblestone, Blocks.iron_ore, Blocks.iron_block, Blocks.coal_ore, Blocks.gold_block, Blocks.gold_ore, Blocks.diamond_ore, Blocks.diamond_block, Blocks.ice, Blocks.netherrack, Blocks.lapis_ore, Blocks.lapis_block, Blocks.redstone_ore, Blocks.lit_redstone_ore, Blocks.rail, Blocks.detector_rail, Blocks.golden_rail, Blocks.activator_rail, CMContent.altarofassociation, CMContent.bouncycobalt, CMContent.cobaltblock, CMContent.cobaltbrick, CMContent.cobaltbrickstair, CMContent.cobaltdoor, CMContent.cobaltfurnace_idle, CMContent.cobaltfurnace_burning, CMContent.cobaltore, CMContent.cobaltstone, CMContent.cobaltbricksingleslab, CMContent.ritualstone, CMContent.cobaltrune});
