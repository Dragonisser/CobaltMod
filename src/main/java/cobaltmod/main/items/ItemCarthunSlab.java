...
public class ItemCarthunSlab extends ItemBlock
{
    ...
    public ItemCarthunSlab(Block p_i45355_1_)
    {
        super(p_i45355_1_);
        this.field_150949_c = CMContent.carthunbricksingleslab;
        this.field_150947_d = CMContent.carthunbrickdoubleslab;
