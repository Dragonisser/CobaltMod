...
public class BlockBlueFire extends BlockFire {
	...
	public static void func_149843_e() {
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.planks), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.double_wooden_slab), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.wooden_slab), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.fence), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.oak_stairs), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.birch_stairs), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.spruce_stairs), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.jungle_stairs), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.log), 5, 5);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.log2), 5, 5);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.leaves), 30, 60);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.leaves2), 30, 60);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.bookshelf), 30, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.tnt), 15, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.tallgrass), 60, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.double_plant), 60, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.yellow_flower), 60, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.red_flower), 60, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.wool), 30, 60);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.vine), 15, 100);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.coal_block), 5, 5);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.hay_block), 60, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(Blocks.carpet), 60, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(CMContent.cobexleaves), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(CMContent.cobexlog), 5, 20);
		((BlockFire) CMContent.bluefire).func_149842_a(getIdFromBlock(CMContent.cobexwood), 5, 20);
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		if (p_149674_1_.getGameRules().getGameRuleBooleanValue("doFireTick")) {
			boolean flag = p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_).isFireSource(p_149674_1_, p_149674_2_, p_149674_3_ - 1, p_149674_4_,
					UP);
			...
			if (!flag
					...
					&& (p_149674_1_.canLightningStrikeAt(p_149674_2_, p_149674_3_, p_149674_4_)
							...
							|| p_149674_1_.canLightningStrikeAt(p_149674_2_ + 1, p_149674_3_, p_149674_4_)
							|| p_149674_1_.canLightningStrikeAt(p_149674_2_, p_149674_3_, p_149674_4_ - 1) || p_149674_1_.canLightningStrikeAt(p_149674_2_,
								...
								if (i1 != p_149674_2_ || k1 != p_149674_3_ || j1 != p_149674_4_) {
									...
									if (i2 > 0) {
										...
										if (j2 > 0 && p_149674_5_.nextInt(l1) <= j2
												...
												&& !p_149674_1_.canLightningStrikeAt(i1 + 1, k1, j1) && !p_149674_1_.canLightningStrikeAt(i1, k1, j1 - 1)
	...
	public void onBlockAdded(World world, int par2, int par3, int par4) {
		if (!CMContent.cobaltportal.func_150000_e(world, par2, par3, par4) && !CMContent.portalcaves.func_150000_e(world, par2, par3, par4)) {
			if (!World.doesBlockHaveSolidTopSurface(world, par2, par3 - 1, par4) && !this.canNeighborBurn(world, par2, par3, par4)) {
				...
				world.scheduleBlockUpdate(par2, par3, par4, this, this.tickRate(world) + world.rand.nextInt(10));
			}
		}
	}
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
		if (p_149734_5_.nextInt(24) == 0) {
			p_149734_1_.playSound((double) ((float) p_149734_2_ + 0.5F), (double) ((float) p_149734_3_ + 0.5F), (double) ((float) p_149734_4_ + 0.5F),
					"fire.fire", 1.0F + p_149734_5_.nextFloat(), p_149734_5_.nextFloat() * 0.7F + 0.3F, false);
		}
		...
		if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_)
				&& !((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP)) {
			if (((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST)) {
				for (l = 0; l < 2; ++l) {
			...
			if (((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST)) {
				for (l = 0; l < 2; ++l) {
			...
			if (((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH)) {
				for (l = 0; l < 2; ++l) {
			...
			if (((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH)) {
				for (l = 0; l < 2; ++l) {
					f = (float) p_149734_2_ + p_149734_5_.nextFloat();
					f1 = (float) p_149734_3_ + p_149734_5_.nextFloat();
			...
			if (((BlockBlueFire) CMContent.bluefire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN)) {
				for (l = 0; l < 2; ++l) {
					f = (float) p_149734_2_ + p_149734_5_.nextFloat();
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.iconArray = new IIcon[] { par1IconRegister.registerIcon("mod_cobalt:bluefire_0"), par1IconRegister.registerIcon("mod_cobalt:bluefire_1") };
	}
