...
public class BlockCobaltFarmland extends Block
{
    ...
    {
        return p_149691_1_ == 1 ? (p_149691_2_ > 0 ? this.field_149824_a : this.field_149823_b) : CMContent.cobaltdirt.getBlockTextureFromSide(p_149691_1_);
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_) && !p_149674_1_.canLightningStrikeAt(p_149674_2_, p_149674_3_ + 1, p_149674_4_))
        {
            ...
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, CMContent.cobaltdirt);
            }
        }
        else
        {
    ...
    public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_, float p_149746_6_)
    {
        if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F)
        {
            ...
            p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, CMContent.cobaltdirt);
        }
    }
    ...
    private boolean func_149821_m(World p_149821_1_, int p_149821_2_, int p_149821_3_, int p_149821_4_)
    {
        for (int l = p_149821_2_ - 4; l <= p_149821_2_ + 4; ++l)
        {
            for (int i1 = p_149821_3_; i1 <= p_149821_3_ + 1; ++i1)
            {
                ...
                {
                    if (p_149821_1_.getBlock(l, i1, j1).getMaterial() == Material.water || p_149821_1_.getBlock(l, i1 + 1, j1) == CMContent.podium)
                    {
                        return true;
                    }
                }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (material.isSolid())
        {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, CMContent.cobaltdirt);
        }
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return CMContent.cobaltdirt.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
