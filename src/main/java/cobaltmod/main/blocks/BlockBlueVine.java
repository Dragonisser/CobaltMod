...
public class BlockBlueVine extends Block implements IShearable {
	...
	private boolean func_150094_e(World p_150094_1_, int p_150094_2_, int p_150094_3_, int p_150094_4_) {
		...
		if (l > 0) {
			for (int j1 = 0; j1 <= 3; ++j1) {
				...
				if ((l & k1) != 0
						&& !this.func_150093_a(p_150094_1_.getBlock(p_150094_2_ + Direction.offsetX[j1], p_150094_3_, p_150094_4_ + Direction.offsetZ[j1]))
						&& (p_150094_1_.getBlock(p_150094_2_, p_150094_3_ + 1, p_150094_4_) != this || (p_150094_1_.getBlockMetadata(p_150094_2_,
								p_150094_3_ + 1, p_150094_4_) & k1) == 0)) {
					i1 &= ~k1;
				}
			}
		}
		...
		if (!p_149674_1_.isRemote && p_149674_1_.rand.nextInt(4) == 0) {
			...
			if (j1 == 1 && p_149674_3_ < 255 && p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_)) {
				...
				if (j2 > 0) {
					for (l1 = 0; l1 <= 3; ++l1) {
						if (!this
								.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[l1], p_149674_3_ + 1, p_149674_4_ + Direction.offsetZ[l1]))) {
							j2 &= ~(1 << l1);
						}
					}
				...
				if (j1 >= 2 && j1 <= 5 && (i1 & 1 << k1) == 0) {
					...
					if (block.getMaterial() == Material.air) {
						...
						if ((i1 & 1 << l1) != 0
								&& this.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[l1], p_149674_3_,
							...
							p_149674_1_.setBlock(p_149674_2_ + Direction.offsetX[k1], p_149674_3_, p_149674_4_ + Direction.offsetZ[k1], this, 1 << l1, 2);
								...
								&& this.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[i2], p_149674_3_,
							...
							p_149674_1_.setBlock(p_149674_2_ + Direction.offsetX[k1], p_149674_3_, p_149674_4_ + Direction.offsetZ[k1], this, 1 << i2, 2);
								...
								&& p_149674_1_.isAirBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[l1], p_149674_3_, p_149674_4_
										+ Direction.offsetZ[k1] + Direction.offsetZ[l1])
								&& this.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[l1], p_149674_3_, p_149674_4_
										+ Direction.offsetZ[l1]))) {
							p_149674_1_.setBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[l1], p_149674_3_, p_149674_4_ + Direction.offsetZ[k1]
									+ Direction.offsetZ[l1], this, 1 << (k1 + 2 & 3), 2);
						} else if ((i1 & 1 << i2) != 0
								&& p_149674_1_.isAirBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[i2], p_149674_3_, p_149674_4_
										+ Direction.offsetZ[k1] + Direction.offsetZ[i2])
								&& this.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[i2], p_149674_3_, p_149674_4_
										+ Direction.offsetZ[i2]))) {
							p_149674_1_.setBlock(p_149674_2_ + Direction.offsetX[k1] + Direction.offsetX[i2], p_149674_3_, p_149674_4_ + Direction.offsetZ[k1]
									+ Direction.offsetZ[i2], this, 1 << (k1 + 2 & 3), 2);
						} else if (this.func_150093_a(p_149674_1_.getBlock(p_149674_2_ + Direction.offsetX[k1], p_149674_3_ + 1, p_149674_4_
								+ Direction.offsetZ[k1]))) {
	 ...
	 */
	public int onBlockPlaced(World p_149660_1_, int p_149660_2_, int p_149660_3_, int p_149660_4_, int p_149660_5_, float p_149660_6_, float p_149660_7_,
