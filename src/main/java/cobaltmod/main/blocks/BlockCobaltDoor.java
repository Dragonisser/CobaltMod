...
public class BlockCobaltDoor extends Block
{
    ...
    public BlockCobaltDoor(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    public void registerBlockIcons(IIconRegister iiconregister)
    {
        ...
        this.field_150017_a[0] = iiconregister.registerIcon("mod_cobalt:cobaltdoor_upper");
        this.field_150016_b[0] = iiconregister.registerIcon("mod_cobalt:cobaltdoor_lower");
