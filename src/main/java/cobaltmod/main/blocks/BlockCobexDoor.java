...
public class BlockCobexDoor extends Block
{
    ...
    public BlockCobexDoor(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    public void registerBlockIcons(IIconRegister iiconregister)
    {
        ...
        this.field_150017_a[0] = iiconregister.registerIcon("mod_cobalt:bluewooddoor_upper");
        this.field_150016_b[0] = iiconregister.registerIcon("mod_cobalt:bluewooddoor_lower");
