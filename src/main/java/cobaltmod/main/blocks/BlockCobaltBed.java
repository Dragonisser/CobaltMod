...
public class BlockCobaltBed extends BlockDirectional
{
    public static final int[][] field_149981_a = new int[][] {{0, 1}, { -1, 0}, {0, -1}, {1, 0}};
    @SideOnly(Side.CLIENT)
    private IIcon[] bed_end;
    @SideOnly(Side.CLIENT)
    private IIcon[] bed_side;
    @SideOnly(Side.CLIENT)
    private IIcon[] bed_top;
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_)
    {
        ...
        if (p_149691_1_ == 0)
        {
            return CMContent.cobaltbrick.getBlockTextureFromSide(p_149691_1_);
        }
        else 
        {
            
            return (i1 != 1 || l != 2) && (i1 != 0 || l != 3) ? (l != 5 && l != 4 ? this.bed_top[i1] : this.bed_side[i1]) : this.bed_end[i1];
        }
    }
    ...
    {
        this.bed_top = new IIcon[] {p_149651_1_.registerIcon( "mod_cobalt:cobaltbed_f_t"), p_149651_1_.registerIcon("mod_cobalt:cobaltbed_h_t")};
        this.bed_end = new IIcon[] {p_149651_1_.registerIcon("mod_cobalt:cobaltbed_f_e"), p_149651_1_.registerIcon("mod_cobalt:cobaltbed_h_e")};
        this.bed_side = new IIcon[] {p_149651_1_.registerIcon("mod_cobalt:cobaltbed_f_s"), p_149651_1_.registerIcon("mod_cobalt:cobaltbed_h_s")};
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
         ...
         */
        return isBlockHeadOfBed(p_149650_1_) ? Item.getItemById(0) : CMContent.cobaltbed1;
    }
    ...
    {
        return this == CMContent.cobaltbed;
    }
}