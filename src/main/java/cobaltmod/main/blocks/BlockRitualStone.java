...
public class BlockRitualStone extends BlockContainer {
	...
	public BlockRitualStone(Material par2Material) {
		super(par2Material);
		this.setHardness(3F).setResistance(4F).setStepSound(Block.soundTypeStone);
	}
	...
	public int getRenderType() {
		return RenderRitualStone.ritualRenderId;
	}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4,
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileEntityRitualStone) par1World.getTileEntity(par2, par3, par4))
	...
	public void breakBlock(World par1World, int par2, int par3, int par4,
		...
		if (!keephighSpeedInventory) {
			TileEntityRitualStone tileentityfurnace = (TileEntityRitualStone) par1World
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World,
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4,
					CMContent.ritualstone);
		} else {
			par1World.setBlock(par2, par3, par4, CMContent.ritualstone);
		}
