...
import cobaltmod.world.dimension.TeleporterCobalt;
...
public class BlockCobaltPortal extends BlockPortal {
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
		if (p_149734_5_.nextInt(100) == 0) {
			p_149734_1_.playSound((double) p_149734_2_ + 0.5D, (double) p_149734_3_ + 0.5D, (double) p_149734_4_ + 0.5D, "portal.portal", 0.5F,
		...
		for (int l = 0; l < 4; ++l) {
			...
			FMLClientHandler.instance().getClient().effectRenderer.addEffect(new EntityBluePortalFX(FMLClientHandler.instance().getClient().theWorld, d0, d1,
					d2, d3, d4, d5));
		}
	}
