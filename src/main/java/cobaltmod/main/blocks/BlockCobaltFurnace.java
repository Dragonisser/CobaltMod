...
public class BlockCobaltFurnace extends BlockContainer {
	...
	public BlockCobaltFurnace(boolean par2) {
		super(Material.rock);
		this.isActive = par2;
		this.setHardness(2F);
	...
	public Block idDropped(int par1, Random par2Random, int par3) {
		return CMContent.cobaltfurnace_idle;
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("mod_cobalt:cobaltfurnace_side");
		this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "mod_cobalt:cobaltfurnace_burning": "mod_cobalt:cobaltfurnace_idle");
		this.furnaceIconTop = par1IconRegister.registerIcon("mod_cobalt:cobaltfurnace_top");
	}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World,
		...
		if (par0) {
			par1World.setBlock(par2, par3, par4,
					CMContent.cobaltfurnace_burning);
		} else {
			par1World.setBlock(par2, par3, par4, CMContent.cobaltfurnace_idle);
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4,
		...
		if (par6ItemStack.hasDisplayName()) {
			((TileEntityCobaltFurnace) par1World
					.getTileEntity(par2, par3, par4))
	...
	public void breakBlock(World par1World, int par2, int par3, int par4,
		...
		if (!keephighSpeedInventory) {
			TileEntityCobaltFurnace var7 = (TileEntityCobaltFurnace) par1World
					.getTileEntity(par2, par3, par4);
			if (var7 != null) {
				for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8) {
					...
					if (itemstack != null) {
						...
						while (itemstack.stackSize > 0) {
							...
							float f3 = 0.05F;
							entityitem.motionX = (double) ((float) this.highSpeedRand
									.nextGaussian() * f3);
							entityitem.motionY = (double) ((float) this.highSpeedRand
									.nextGaussian() * f3 + 0.2F);
							entityitem.motionZ = (double) ((float) this.highSpeedRand
									.nextGaussian() * f3);
