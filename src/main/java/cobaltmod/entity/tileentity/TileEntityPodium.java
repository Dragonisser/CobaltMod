...
public class TileEntityPodium extends TileEntity implements ISidedInventory
{
    private static final int[] slots_main = new int[] {0};
    /**
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockPodium.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    {
        return par1 == 1 ? slots_main : slots_main ;
    }
