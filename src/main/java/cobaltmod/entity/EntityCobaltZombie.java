...
public class EntityCobaltZombie extends EntityMob
{
 ...
 public void onKillEntity(EntityLivingBase par1EntityLivingBase)
 {
     ...
     if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && par1EntityLivingBase instanceof EntityPlayer)
     {
...
public void onLivingUpdate()
 {
  /*   if (this.worldObj.isDaytime() && !this.worldObj.isRemote)
     {
    	 EntityCobaltZombie entitycz = this; 
    	 
    	 if (entitycz.dimension != mod_cobalt.cobaltdimension)
    	 {
